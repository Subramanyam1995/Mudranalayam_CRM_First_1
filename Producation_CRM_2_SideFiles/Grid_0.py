...
def Push_To_CRM_Database_First_Time_Grid_0(value_inputed, Phone_Saved_Name__0101,Source_of_Collection__010102, Updated_Office_Name__0102):
    ...
    Database[f"01_{value_inputed}"][f"0101__{value_inputed}__Phone_Saved_Name"][f"010102__{value_inputed}__Source"]=Source_of_Collection__010102
...
def Pusher_grid_0(value,Phone_Saved_Name__0101,Source_of_Collection,Updated_Office_Name__0102):
    ...
    tk.Button(window_pusher, text="Publish", command=lambda:Push_To_CRM_Database_First_Time_Grid_0(value,Phone_Saved_Name__0101,Source_of_Collection, Updated_Office_Name__0102)).grid(row=3,column=0,columnspan=2)
...
def grid_0(window,value_inputed):
    ...
    Source__010102 = tk.StringVar(value="Not_selected")    
    ...
    tk.Button(window_01_01_01, text="Pusher", font='Bahnschrift 12 bold', command=lambda:Pusher_grid_0(value_inputed,Name__010101.get(),Source_of_Collection.get(),OfficeName__01021.get())).grid(row=7,columnspan=2,column=0)  
